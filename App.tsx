...
export default function App() {
  ...
  useEffect(() => {
    fetch('/api/products')
      ...
      .then(data => Array.isArray(data.products) && data.products.length && setProducts(data.products))
      .catch(() => undefined);
  }, []);
    ...
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero">
          ...
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <button className="button primary" onClick={scrollToStore}>Browse the store <ArrowRight size={17} /></button>
              <a className="button secondary" href="#factory">Explore the Factory</a>
            </div>
        ...
        <section className="stats">
          <div><strong>Research</strong><span>Validate the niche before you write.</span></div>
          <div><strong>Create</strong><span>Build polished books faster.</span></div>
          <div><strong>Package</strong><span>Professional covers and formats.</span></div>
          <div><strong>Sell</strong><span>Own your catalog and customer library.</span></div>
        </section>

        <section id="store" className="section store-section">
          <div className="section-heading">
            <div><div className="eyebrow">THE MARKETPLACE</div><h2>Books built to be useful.</h2><p>Browse practical digital products created for people who want an actionable result, not filler.</p></div>
